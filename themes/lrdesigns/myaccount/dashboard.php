...
?>
<?php 
// Lets get some user information for display
$user_name = isset($current_user->first_name) ? $current_user->first_name : $current_user->display_name;
?>

<div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <?php _e("<h1>Welcome " .$user_name. "</h1>"); ?>
            </div>
        </div>
    <div class="row">
        <div class="col-md-12">
