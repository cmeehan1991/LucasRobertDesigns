...
class CurrentOrdersModel: NSObject{
    ...
    func downloadItems(){
        ...
        var parameters = "action=" + "summary-pending"
    ...
    func parseJSON(data: Data){
        ...
        DispatchQueue.main.async{
            self.delegate?.currentItemsDownloaded(orderID: orderID, orderDate: orderDate, orderStatus: orderStatus, itemNames: orderItems, itemID: orderItemIDs)
        }
    }
