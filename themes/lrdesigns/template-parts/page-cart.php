...
<div class="container-fluid">
    <div class='row'>
        <div class="col-md-12" align="center">
            <?php _e(the_title('<h1>', '</h1>'), LR_TEXTDOMAIN); ?>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12 col-md-10" align="center">
            ...
            <table class="shop_table shop_table_responsive cart" cellspacing="0" style="min-width:75%">
                <thead>
                    <tr>
                ...
                <tbody>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <?php
                                                // Meta data
                                                echo WC()->cart->get_item_data($cart_item, true);
                                                ?>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    ?>
                    <tr>
                        <td colspan="6" class="actions" align="right">
